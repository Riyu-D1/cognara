-- StudyFlow Social Features Database Schema
-- Run this in your Supabase SQL editor to add social functionality
-- This schema is inspired by LinkedIn and Instagram's social features
...
-- ============================================
-- SOCIAL POSTS TABLE (Like Instagram/LinkedIn Feed)
-- ============================================
...
-- ============================================
-- USER FOLLOWERS TABLE (Like Instagram/LinkedIn)
-- ============================================
...
-- ============================================
-- SAVED POSTS TABLE (Like Instagram saves)
-- ============================================
...
-- Social Posts: Public read for public posts, authenticated users can create
...
-- Post Likes: Anyone can view, authenticated users can like
...
-- Post Comments: Anyone can view, authenticated users can comment
...
-- Comment Likes: Anyone can view, authenticated users can like
...
-- User Followers: Public read, users can follow/unfollow
...
-- Study Groups: Public groups visible to all, members can view private groups
...
-- Study Group Members: Members can view, admins can manage
...
-- Study Group Posts: Members can view and post
...
-- User Achievements: Public read, system writes
...
-- Study Streaks: Public read, owner write
...
-- Trending Topics: Public read, system writes
